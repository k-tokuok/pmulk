...
(* $Id: mulk/pascal p52.pas 1530 2026-01-24 Sat 21:17:55 kt $ *)
const
  n=3;
  pi=3.14159265; d=180;
...
var
  ...
  function product(x, y: vector): real;
  var i: 1..n; lxy: real;
  begin
    lxy:=0;
  ...
  function length(x: vector): real;
  begin
    length:=sqrt(product(x,x))
  end;

...
1:  fcp := lcp
  ...
  procedure block(fsys: setofsys; fsy: symbol; fprocp: ctp);
    ...
    procedure body(fsys: setofsys);
      ...
      procedure putic;
      begin if ic mod 10 = 0 then writeln(prr,'i',ic:1) end;
            ...
            case fop of
              ...
              47,48,49,52,53,55:
                begin write(prr,chr(fp1));
                  if chr(fp1) = 'm' then write(prr,' ',fp2:1);
                  writeln(prr)
                end;
              51:
                case fp1 of
                  ...
                  5: begin write(prr,'(');
                       with cstptr[fp2]^ do
                         for k := setlow to sethigh do
                           if k in pval then write(prr,' ',k:1);
                       writeln(prr,')')
                     end
                end
            end;
      ...
      begin load;
        ...
        if prcode then begin putic; writeln(prr,mn[33]:4,' l',faddr:1) end;
        ic := ic + 1; mes(33)
      end (*genfjp*) ;
      ...
      begin
        if prcode then
          begin putic;
            writeln(prr,mn[fop]:4,' ',fp1:1,' l',fp2:1)
          end;
        ic := ic + 1; mes(fop)
      end;
      ...
      begin if prcode then writeln(prr, 'l',labname:1)
      end (*putlabel*);
    ...
    begin (*body*)
      ...
      if fprocp <> nil then
        begin
          ...
          align(parmptr,lcmax);
          if prcode then
            begin writeln(prr,'l',segsize:1,'=',lcmax:1);
              writeln(prr,'l',stacktop:1,'=',topmax:1)
            end
        end
      else
...
begin
  ...
  if totalerror <> 0 then writeln('!',totalerror:0,' errors')
end.

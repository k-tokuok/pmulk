...
$Id: mulk ol.m 932 2022-09-18 Sun 17:45:15 kt $
#ja アウトラインファイル処理
...
.caption OPTION
	...
	v -- Outputs the outline line as it is.
...
*ol tool.@
	...
	Object addSubclass: #Cmd.ol instanceVars: "reader levels"
		+ " body? levelIndent? header? pick skipAnnex? verbatim?"
**Cmd.ol >> putBlock
	...
	reader nextBlock
**Cmd.ol >> main: args
	OptionParser new init: "sihp:Sv" ->:op, parse: args ->args;
	op at: 's', not ->body?;
	op at: 'i' ->levelIndent?;
	op at: 'h', not ->header?;
	op at: 'p' ->pick;

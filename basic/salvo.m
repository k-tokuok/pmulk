...
$Id: mulk/basic salvo.m 1442 2025-06-12 Thu 10:05:28 kt $
...
The player has 4 ships: battle ship (5 squares), cruiser (3 squares) and two destroyers (2 squares each).
The ships may be placed horizontally, vertically, or diagonally and must not overlap.
The ships do not move during the game.

As long as any squares of a battleship still survives, the player is allowed three shots, for a cruiser 2 shots, and for each destroyer 1 shot.
The player enters all of his shots and the computer tells what was hit.
A shot is entered by its grid coordinate x,y.
The winner is the one who sinks all of the opponent's ships.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Lawrence Siegel, Shaker heights, Ohio.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.salvo
**Cmd.salvo >> main: args
	Basic new breakFor run: #Cmd.salvo.source

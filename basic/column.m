old card trick
$Id: mulk/basic column.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	column
.caption DESCRIPTION
This program is a computer version of an old card trick which never fails to get come ooohs and aaahs from the uninitiated.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.column
**Cmd.column >> main: args
	Basic new breakFor run: #Cmd.column.source

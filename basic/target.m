firing a weapon in 3 dimensional space
$Id: mulk/basic target.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	target
.caption DESCRIPTION
Your ship is located at the origin (0, 0, 0) of a set of x, y, z coordinates.
You will be told the approximate location of the target in 3 dimensional rectangular coordinates, the approximate angular deviation from the x and z axes in both radians and degrees, and the approximate distance to the target.

Given this information, you then procees to shoot at the target.
A shot within 20 kilometers of the target destroys it.
After each shot, you are given information as to the position of the explosion of your shot and a somewhat improved estimate of the location of the target.
Fortunately, this is just practice and the target doesn't shoot back.
After you have attained proficiency, you ought to be ablt to destroy a target in 3 or 4 shots.
However, attaining proficiency might take a while.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.vintage-basic.net/
.caption AUTHOR
H. David Crocket, Fort Worth, Texas.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.target
**Cmd.target >> main: args
	Basic new run: #Cmd.target.source

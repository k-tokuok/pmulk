connect the dots
$Id: mulk/basic condot.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	condot
.caption DESCRIPTION
The objective is to carve out squares of "real estate" with the computer as an able adversary.
The player who connects the two dots which complete a square gets ownership of that square.
In addition, the player gets the added bonus of moving once more.
This can be quite advantageous in certain situations.
A nine-square grid is provided as a playing board.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.condot
**Cmd.condot >> main: args
	Basic new run: #Cmd.condot.source

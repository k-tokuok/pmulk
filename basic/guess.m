guess the number
$Id: mulk/basic guess.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	guess
.caption DESCRIPTION
The computer chooses a random integer between 1 and any limit you set.
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.guess
**Cmd.guess >> main: args
	Basic new run: #Cmd.guess.source

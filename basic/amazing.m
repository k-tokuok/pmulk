print out maze
$Id: mulk/basic amazing.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	amazing
.caption DESCRIPTION
This program will print out a different maze every time it is run and guarantees only one path through.
You can choose the dimensions of the maze --i.e. the number of squares wide and long.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Jach Hauber of Windsor, Connecticut.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.amazing
**Cmd.amazing >> main: args
	Basic new run: #Cmd.amazing.source

dialogue with chief numbers freek
$Id: mulk/basic chief.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	chief
.caption DESCRIPTION
Give people (mostly kids) practice in the four operation (addition, multiplication, subtraction and division).
It does this while giviong people some fun.
And then, if the people are wrong, it shows them how they should have done it.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
John Graham, Upper Brookville, New York.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.chief
**Cmd.chief >> main: args
	Basic new run: #Cmd.chief.source

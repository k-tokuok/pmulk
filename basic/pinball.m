computer pinball
$Id: mulk/basic pinball.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	pinball
.caption DESCRIPTION
PINBALL is, naturally enough, a simulated pinball game -- complete with bells if your terminal has them -- in which the computer serves as the pinball machine.
However, you don't need any quarters!
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.pinball
**Cmd.pinball >> main: args
	Basic new run: #Cmd.pinball.source

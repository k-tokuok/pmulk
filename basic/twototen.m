game of chance with 2-10 deck
$Id: mulk/basic twototen.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	twototen
.caption DESCRIPTION
Two-to-Ten is a game of chance played with a special deck of cards with only the cards 2-10.
The game is similar to blackjack in that you are drawing cards and trying to come as close as possible to a goal number (chosen at random before each round) without going over it.
You must come within a certain number of points of the goal number determined by a "lucky-limit" card.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.twototen
**Cmd.twototen >> main: args
	Basic new run: #Cmd.twototen.source

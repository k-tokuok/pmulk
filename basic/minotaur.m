cavern of the minotaur
$Id: mulk/basic minotaur.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	minotaur
.caption DESCRIPTION
In this game, you are in a three level cavern.
Inside the cavern are ten pillars which stretch through all three levels; they're electrified so that if you touch them, you are immediately vaporized.
Furthermore, there are trap doors which appear randomly and drop you down one level.
The top level is three, the second level is two, the first or lowest level is one.
If a trap door appears in level one you are dropped into a bottomless pit and that ends the game.
The minotaur itself also poses a hazard.
If you wound him with your spear, he will charge you.
Also, he randomly charges for no reason at all.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.minotaur
**Cmd.minotaur >> main: args
	Basic new breakFor run: #Cmd.minotaur.source

jumping balls solitaire
$Id: mulk/basic jmpngbll.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	jmpngbll
.caption DESCRIPTION
Jumping balls is a solitaire board game played with a board having nine holes in a line that can be filled with four silver balls to the left end and four gold balls to the right end.
the object of the game is to reverse the position of the balls from one end of the board to the other.

You may make a move by moving a ball to the immediately adjacent empty hold or by jumping one other ball.
You may not jump two or more balls.
Holes are numbered from left to right.
At the beginning of the game, hole number five is free.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.jmpngbll
**Cmd.jmpngbll >> main: args
	Basic new run: #Cmd.jmpngbll.source

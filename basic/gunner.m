artillery weapon gunner
$Id: mulk/basic gunner.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	gunner
.caption DESCRIPTION
GUNNER allows you to adjust the fire of a field artillery weapon to hit a stationary target.
You specify the number of degrees of elevation of your weapon.

You get up to five shots to destory the enemy before he destroyes you.
You must specify elevation within approximately 0.2 degrees to get a hit.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Tom Kloos, Oregon Meseum of Science and Industry, Portland, Oregon.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.gunner
**Cmd.gunner >> main: args
	Basic new run: #Cmd.gunner.source

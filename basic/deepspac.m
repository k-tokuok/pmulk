deep space battle
$Id: mulk/basic deepspac.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	deepspac
.caption DESCRIPTION
You became the commander of either a scout ship, cruiser, or battleship.
You then pick the weapons, and planetary system to patrol, and it's time to do battle.

The closer you get to the enemy, the better your chance of destorying him.
Unfortunately, his chance of destroying you also improves.
If you get too close, you can damege yourself; when a vassel's damage rating reaches or exceeds 100, it's destoryed.
.caption ORIGIN
...
Originally appeared in Creative Computing, Mar/Apr 1976.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.deepspac
**Cmd.deepspac >> main: args
	Basic new run: #Cmd.deepspac.source

escape from man eating rabbit
$Id: mulk/basic mnetngrb.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	mnetngrb
.caption DESCRIPTION
In this game you are in a pit with a man-eating rabbit.
The center of the pit, appropriately enough, is at 0, 0, and it has a radius of ten.
On each move, you can move in any one of eight different angles, 0, 45, 90, 135... etc.
Unlike you, the rabbit can take more than one hop on a move.
The object of the game is to avoid the rabbit for ten moves.
If you do this successfully you'll be released and set free.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.mnetngrb
**Cmd.mnetngrb >> main: args
	Basic new run: #Cmd.mnetngrb.source

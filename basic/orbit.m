shoot the Romulan spaceship in orbit
$Id: mulk/basic orbit.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	orbit
.caption DESCRIPTION
ORBIT challenges you to visualize spatial position in polar coordinates.
The object is to detonate a Photon explosive within a certain distance of a germ laden Romulan spaceship.
This ship is orbiting a planet at a constant altitude and orbital rate.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Jeff Lederer, Project SOLO, Pittsburgh, Pennsylvania.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.orbit
**Cmd.orbit >> main: args
	Basic new run: #Cmd.orbit.source

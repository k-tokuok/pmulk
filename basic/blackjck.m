...
$Id: mulk/basic blackjck.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	blackjck
.caption DESCRIPTION
This is a simulation of the card game of Blackjack or 21, Las Vegas style.
This rather comprehensive version allows for up to seven players.
On each hand each player may get another card (a hit), stand, split a hand in the event two identical cards were received or double down.
Also, the dealer will ask for an insurance bet if he has an exposed ace.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.blackjck
**Cmd.blackjck >> main: args
	Basic new implicitDeclareArray breakFor run: #Cmd.blackjck.source

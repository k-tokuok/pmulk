conway's life game
$Id: mulk/basic lifeb.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	lifeb
.caption DESCRIPTION
The Game of Life was originally described in Scientific American, October 1970, in an article by Martin Gardner.
The game itself was originated by John Conway of Gonville and Caius Colledge, University of Cambridge, England.

To enter leading blanks in the pattern, type a "." at the start of the line.
This will be converted to a space, but it permits you to type leading spaces.
Typing DONE indicated that you are finished entering the pattern.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Clark Baker, Project DELTA.

Modified by Steve North, Creative Computing.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.lifeb
**Cmd.lifeb >> main: args
	Basic new run: #Cmd.lifeb.source

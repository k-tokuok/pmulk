struggle for superiority of space
$Id: mulk/basic ufo.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	ufo
.caption DESCRIPTION
UFO is a strategy game in which you play against the computer in life-and-death struggle for superiority of space.
It takes place after a space war with another planet in which both earth and the attacker's planet are destoryed.
Both planets -- basically similar in strength, social structure, and scientific awareness -- realizing they are doomed, launch a "lifeboat" into space.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.ufo
**Cmd.ufo >> main: args
	Basic new run: #Cmd.ufo.source

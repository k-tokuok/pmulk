...
$Id: mulk/basic boxing.m 1442 2025-06-12 Thu 10:05:28 kt $
...
The computer coaches one of the boxers and determines his punches and defenses, while you do the same for your boxer.
At the start of the match, you may specify your man's best punch and his vulnerability.

There are approxmately seven major punches per round.
The best two out of three rounds wins.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Jesse Lynch, St. Paul, Minnesota.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.boxing
**Cmd.boxing >> main: args
	Basic new run: #Cmd.boxing.source

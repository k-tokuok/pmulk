...
$Id: mulk/basic lfexpctn.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	lfexpctn
.caption DESCRIPTION
This program is a life expectancy test derived from Peter Passell's book "How To".
The test asks you a series of questions dealing with your life-style and environment.
At the end of the questioning, the program gives your estimated life expectancy and a percentage of the population you should alive.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.lfexpctn
**Cmd.lfexpctn >> main: args
	Basic new run: #Cmd.lfexpctn.source

...
$Id: mulk/basic mazeb.m 1442 2025-06-12 Thu 10:05:28 kt $
...
In the first part, the program generates a maze which you can them try to find your way through with pencil and paper.

In the second part of the program is a near-sighted mouse is let loose in the maze and explorers until he finds his way through.
If you want to know what near-sighted means, run the program and ask to see the solution step by step as the mouse goes through the maze.
If you elect not to see each step, you'll simply get a total solution for the maze itself.

With or without the mouse, it's a fun program and the larger mazes are frequently a real challenge to solve.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.mazeb
**Cmd.mazeb >> main: args
	Basic new run: #Cmd.mazeb.source
...
220 rem CLEAR 100: REM ERASE ALL ARRAYS AND VARIABLE VALUES
230 INPUT H,V

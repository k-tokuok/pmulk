artillery fires at an opponent
$Id: mulk/basic artllry3.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	artllry3
.caption DESCRIPTION
In this game, two or three humans may play.
Each one of them has an artillery piece and is fireing at an opponent.
The first person to destroy his opponent wins that round of the game.
.caption ORIGIN
...
Revised by N. E. Lyon and Brian West.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.artllry3
**Cmd.artllry3 >> main: args
	Basic new run: #Cmd.artllry3.source

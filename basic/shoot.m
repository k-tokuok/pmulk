shoot atomic missiles
$Id: mulk/basic shoot.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	shoot
.caption DESCRIPTION
After a total nuclear war, the last two survivors kill each other.

See run-time instructions for details.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.shoot
**Cmd.shoot >> main: args
	Basic new run: #Cmd.shoot.source

board game with self learning player
$Id: mulk/basic hexapawn.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	hexapawn
.caption DESCRIPTION
The game of hexapawn and a method to learn a strategy for playing the game was described in Martin Gardner's "Mathematical Games" column in the March 1962 issue of Scientific American.
.caption ORIGIN
...
Modified by Jeff Dalton and Steve North, Creative Computing.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.hexapawn
**Cmd.hexapawn >> main: args
	Basic new breakFor implicitDeclareArray run: #Cmd.hexapawn.source

word guessing game
$Id: mulk/basic word.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	word
.caption DESCRIPTION
WORD is a combination of HANGMAN and BAGELS.
In this game, the player must guess a word with clues as to letter position furnished by the computer.
However, instead of guessing one letter at a time, in WORD you guess an entire word (or group of 5 letters, such as ABCDE).
The computer will tell you if any letters that you have guessed are in the mystery word and if any of them are in the correct position.
Armed with these clues, you go on guessing until you get the word, if you can't get it, input a "?" and the computer will tell you the mystery word.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Charles Reid, Lexington, Massachusetts.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.word
**Cmd.word >> main: args
	Basic new run: #Cmd.word.source

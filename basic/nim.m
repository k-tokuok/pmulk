take last pile
$Id: mulk/basic nim.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	nim
.caption DESCRIPTION
NIM is one of the oldest two-person games known to man; it is believed to have originated in ancient China.

Opponents take turns removing objects until there are none left.
The one who picks up the last object wins.

This is generalized game which allows you to specify any starting size for the four piles and also a win option.
To play traditional NIM, you would simply specify 7, 5, 3 and 1, and win option 1.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Unknown, Dartmouth College

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.nim
**Cmd.nim >> main: args
	Basic new run: #Cmd.nim.source

simulated bullfight
$Id: mulk/basic bullfght.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	bullfght
.caption DESCRIPTION
You are the matador -- i.e., the one with the principal role and the one who must kill the bull or be killed (or run from the ring).
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
David Sweet, Dartmouth.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.bullfght
**Cmd.bullfght >> main: args
	Basic new implicitDeclareArray run: #Cmd.bullfght.source

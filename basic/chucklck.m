...
$Id: mulk/basic chucklck.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	chucklck
.caption DESCRIPTION
Chuck-a-luck is generally found in fairgrounds, cheap casinos, and small gambling parlors.

Player places his bets on one of the six numbers, one through six.
When bet have been places, the operator tumbles three dice in a chuck cage until they come to rest face up or drop down a chute onto the table.
If a player's number appears on one die, the operator pays him even money; if on two dice, two to one; if on three dice, three to one.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.chucklck
**Cmd.chucklck >> main: args
	Basic new run: #Cmd.chucklck.source

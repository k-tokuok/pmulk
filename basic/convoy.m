naval war to destroy a cargo ship
$Id: mulk/basic convoy.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	convoy
.caption DESCRIPTION
This is a naval war game played on a 10 by 10 grid.
You are a submarine and the computer plays the role of the convoy consisting of a cargo ship and two destroyers.

This game ends when either the submarine destroys the cargo ship or when one of the two destroyers gets the submarine.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.convoy
**Cmd.convoy >> main: args
	Basic new run: #Cmd.convoy.source

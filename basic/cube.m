travel the surface of a cube
$Id: mulk/basic cube.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	cube
.caption DESCRIPTION
CUBE is a game played on the facing sides of a cube with a side dimension of 2.
A location is designated by three numbers -- e.g., 1,2,1.
The object is to travel from 1,1,1 to 3,3,3 without striking landmines.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Jerimac Ratliff, Fort Worth, Texas.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.cube
**Cmd.cube >> main: args
	Basic new run: #Cmd.cube.source

guess the number once
$Id: mulk/basic number.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	number
.caption DESCRIPTION
You get only one guess per play and you gain or lose points depending upon how close your guess is to the random number selected by the computer.
You occasionally get a jackpot which will double your point count.
You win whenyou get 500 points.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Tom Adametx, Sudbury, Massachusetts.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.number
**Cmd.number >> main: args
	Basic new run: #Cmd.number.source

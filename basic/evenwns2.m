pick even marbles to win version 2
$Id: mulk/basic evenwns2.m 1442 2025-06-12 Thu 10:05:28 kt $
...
The players alternate turns, with each players removing from 1 to 4 marbles on each move.
The game ends when there are no marble left, and the winner is the one with an even number of marbles.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.evenwns2
**Cmd.evenwns2 >> main: args
	Basic new run: #Cmd.evenwns2.source

acid dilution game
$Id: mulk/basic chemist.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	chemist
.caption DESCRIPTION
Determine how match water to add for dilution from an amount of acid.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Wayne Teeter, Ridgecreast, California.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.chemist
**Cmd.chemist >> main: args
	Basic new run: #Cmd.chemist.source

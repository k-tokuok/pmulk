...
$Id: mulk/basic civilwar.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	civilwar
.caption DESCRIPTION
This simulation is based on 14 battles in the Civil War.
Facts and figures used are based on the actual occurrence.
If you follow the same strategy used in the actual battle, the results will be the same.
Generally, this is a good strategy since the generals in the Civil War were fairly good military strategists.
However, you can frequently outperform the Civil War generals, particularly in cases where they did not have good enemy intelligence and consequently followed a poor course of action.
Naturally, it helps to know your Civil War history, although the computer gives you the rudiments.

After each of the 14 battles, your casualities are compared to the actual casualities of the battle, and you are told whether you win or lose the battle.

You may play Civil War alone in which case the program simulates the Union general.
Or two players may play in which case the computer becomes the moderator.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.vintage-basic.net/
.caption AUTHOR
L. Cram, L. Goodie and D. Hibbard at Lexington High School, Massachusetts.

*entity.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.civilwar
**Cmd.civilwar >> main: args
	Basic new implicitDeclareArray run: #Cmd.civilwar.source

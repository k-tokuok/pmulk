...
$Id: mulk/basic defuse.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	defuse
.caption DESCRIPTION
In this game, you are in an experimentail building with one million rooms in it.
The building is one hundred rooms long, one hundred rooms wide, and one hundred rooms high.

You have juse received a telephone call from a mad bomber who tells you he has planted a bomb someplace in the building.
Fortunately you are armed with a bomb detector that registers a stronger and stronger signal as you get closer to the bomb.
You start at the bottom right-hand door of the building, at the room 0, 0, 0.
In response to the signals from your detector, every ten seconds you may try a new room to search for the bomb.
You have two hundred seconds or twenty trials to find it.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.defuse
**Cmd.defuse >> main: args
	Basic new run: #Cmd.defuse.source

...
$Id: mulk/basic orient.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	orient
.caption DESCRIPTION
The Orient Express places you aboard that famous train bound from London, England to Constantinople in February 1923.
As a secret agent your assignment is to make contact with an arms dealer who has tired of his life of crime, and arrest the killer of one of his former associates.

Some of the passengers on the train (all of whom are historical characters who actually rode the Express in their day) have information that can help you complete your assignment.
As you work your way through the mystery, you participate in many of the things?delicious meals, stops at stations along the way, and occasional delays due to snow, derailment, and bandits?that made the Orient Express an unforgettable experience for those who rode it.

Solving the puzzle is not easy.
You will probably want to make notes about meaningful clues and take some time to think?hours perhaps?before talking to the Turkish police (who will help you) at Uzunkopru.
Bear the following in mind as you play the game:
.item
You must identify and protect the sender of the note and identify and arrest the killer of Baron Wunster.
.item
Five notorious arms dealers, all of different nationalities, are currently operating in Europe under an uneasy truce.
Each of them deals in a different type of weapon, and all are known to have different tastes and habits.
.item
Not all of the passengers with whom you speak have useful information.
You cannot talk to passengers during sleeping segments of the trip.
.item
Unless you have extraordinary deductive powers, it will probably take you at least an hour of play to solve the mystery.
(Of course, you can cheat and do some sleuthing in the program listing, but that will probably take you almost as long and be a lot less fun.)

So grab your notebook and your ticket, and start asking questions.
Remember, a man's life is at stake!
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.orient
**Cmd.orient >> main: args
	Basic new breakFor run: #Cmd.orient.source
...
920 if rn<0 then a5=5 else CS(RN)=CS(CM) : 'subscript out of range occur
921 FOR KA=79 TO 1 STEP -1
...
2550 FOR I=1 TO 25 : READ MD$(I) : NEXT I : 'Dinner selections
2551 A5=4 : 'read error occur
2560 RETURN
...
2970 A3=A3+5*(J+1)-61 : WHILE LEN(INKEY$)=0 : WEND : CLS : RETURN
2971 'pos(x) may 61.
2980 '
...
3330 PRINT "Okay.  So long for now." : GOSUB 2860 : END

...
$Id: mulk/basic rocket.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	rocket
.caption DESCRIPTION
You start 500 feet above the lunar surface and control the burn rate in 1-second bursts.
Each unit of fuel slows your descent by 1 ft/sec.
The maximum thrust of your engine is 30 ft/sec/sec.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.rocket
**Cmd.rocket >> main: args
	Basic new run: #Cmd.rocket.source
...
210 PRINT"CONTROL 500 FEET ABOVE A GOOD LANDING SPOT. YOU HAVE A DOWN-"
220 PRINT"WARD VELOCITY OF 50 FEET/SEC. 120 UNITS OF FUEL REMAIN."
225 PRINT

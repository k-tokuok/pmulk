reach goal before the twonky gets you
$Id: mulk/basic twonky.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	twonky
.caption DESCRIPTION
The computer will set up a 15x15 playing field in which you are randomly located.
Also inside the field is an objective square, 30 blocked squares (walls), 22 relocation squares, and 1 super special new maze square, and, of course, the Twonky (which is no relation to a creme-filled cupcake).

To win the game, you must reach the objective square before the Twonky gets you, by moving one square at a time, forward, backward, right or left.

After you move, the Twonky moves toward you.
He is impervious to all traps, even walls.
When he gets too close to you (2 or fewer squares), you lose.
However, you are equipped with a de-materializing ray gun.
You have the option of using this on your turn.
If you hit the Twonky, he de-materializes on a different square of the maze to resume his his quest after you.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.twonky
**Cmd.twonky >> main: args
	Basic new run: #Cmd.twonky.source

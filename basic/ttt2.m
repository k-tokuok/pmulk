tic tac toe 2nd version
$Id: mulk/basic ttt2.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	ttt2
.caption DESCRIPTION
This version includes which prints out the board after each move.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.vintage-basic.net/
.caption AUTHOR
Curt Flick, Akron, Ohio.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.ttt2
**Cmd.ttt2 >> main: args
	Basic new run: #Cmd.ttt2.source

four in a row
$Id: mulk/basic fourinrw.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	fourinrw
.caption DESCRIPTION
In this game, eight pegs are put in a row, each one of which can hold eight rings.
Each ring is marked with either an X or an O.
You and an opponent alternate turns; in this case the opponent is the computer.
On each turn you place a ring over one of the pegs, one through eight.
The object is to get four X's or O's in a row, vertically, horizontally or diagonally.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.fourinrw
**Cmd.fourinrw >> main: args
	Basic new run: #Cmd.fourinrw.source

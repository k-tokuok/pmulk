poem generator
$Id: mulk/basic poetry.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	poetry
.caption DESCRIPTION
This program produces random verse which might loosely be considered in the Japanese Haiku Style.
...
Modified by Jim Bailey, Peggy Ewing and Dave Ahl, DEC.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.poetry
**Cmd.poetry >> main: args
	Basic new run: #Cmd.poetry.source

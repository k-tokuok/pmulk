kinematics test
$Id: mulk/basic kinema.m 1442 2025-06-12 Thu 10:05:28 kt $
...
It presents a simple problem: a ball is thrown straight up in the air at some randorn velocity.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Richard Pav, Patchogue High School, Patchogue, New York.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.kinema
**Cmd.kinema >> main: args
	Basic new run: #Cmd.kinema.source

create magic square
$Id: mulk/basic magicsqr.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	magicsqr
.caption DESCRIPTION
The goal is to form a sum 15 magic square with you and the computer alternately filling in the integers between 1 and 9.
If one player sumbles and puts a number in which causes the sum of a row, column, or diagonal to be something other than 15, he loses.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.magicsqr
**Cmd.magicsqr >> main: args
	Basic new breakFor run: #Cmd.magicsqr.source

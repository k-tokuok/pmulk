card game of war
$Id: mulk/basic war.m 1442 2025-06-12 Thu 10:05:28 kt $
...
In War, the card deck is shuffled, then two cards are dealt, one to each player.
Players compare cards and the numerically higher card wins.
In case of a tie, no one wins.
The game ends when you have gone through the whole deck or when you decide to quit.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.war
**Cmd.war >> main: args
	Basic new breakFor run: #Cmd.war.source

...
$Id: mulk/basic big6.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	big6
.caption DESCRIPTION
You can bet on any number between one and six and up to three numbers.
.caption ORIGIN
More basic computer games.
.
source from https://www.roug.org/
.caption AUTHOR
Steve Heywood and Dave Alvey.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.big6
**Cmd.big6 >> main: args
	Basic new run: #Cmd.big6.source

...
$Id: mulk/basic roulette.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	roulette
.caption DESCRIPTION
This game simulates an American Roulette wheel; "American" because it has 38 number compartments (1 to 36, 0 and 00).

In this game, you may bet from $5 to $500 and you may bet on red or black, odd or even, first or second 18 numbers, a column, or single number.
You may place any number of bets on each spin of the wheel.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.roulette
**Cmd.roulette >> main: args
	Basic new run: #Cmd.roulette.source

simulation of an aircraft dropping a bomb
$Id: mulk/basic bombrun.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	bombrun
.caption DESCRIPTION
You may specify whether the aircraft is climbing, diving, and the angle in degrees.
You may specify speed in feet per seocnd.
You may also specify at what point you wish to drop the bomb.
The program gives you four passes over the target.

A perfect hit is possible but extremely difficult to achieve.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.bombrun
**Cmd.bombrun >> main: args
	Basic new implicitDeclareArray breakFor run: #Cmd.bombrun.source

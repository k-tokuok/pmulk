french fur trading expedition
$Id: mulk/basic furtradr.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	furtradr
.caption DESCRIPTION
You are the leader of a French fur trading expedition in 1776 leaving the Ontario area to sell furs and get supplies for the next year.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Dan Bachor, University of Calgary, Alberta, Canada.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.furtradr
**Cmd.furtradr >> main: args
	Basic new run: #Cmd.furtradr.source

large banner on a terminal
$Id: mulk/basic bannerb.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	bannerb
.caption DESCRIPTION
This program creates a large banner on a terminal of any message you input.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Leonard Rosendust, Brooklyn, New York.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.bannerb
**Cmd.bannerb >> main: args
	Basic new implicitDeclareArray breakFor run: #Cmd.bannerb.source

seek boga before boga find you
$Id: mulk/basic boga2.m 1442 2025-06-12 Thu 10:05:28 kt $
...
Like a Hurkle, the Boga hides on a grid.
It sends out clues that tell you which direction to move from where you are to where it is.
However, one major difference between a Boga and Hurkle is the Boga is also seeking you out at the same time you are looking at.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.boga2
**Cmd.boga2 >> main: args
	Basic new run: #Cmd.boga2.source

guess the letter
$Id: mulk/basic letter.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	letter
.caption DESCRIPTION
The computer picks a random letter of the alphabet and you must guess which one it is using the clues provided as you go along.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Bob albrecht, Peoples's Computer Company.

*entry.@
	Object addSubclass: #Cmd.letter
**Cmd.letter >> main: args
	Basic new run: #Cmd.letter.source

2-player strategic board game
$Id: mulk/basic lgame.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	lgame
.caption DESCRIPTION
The L-game is a 2-player strategic game played on a 4x4 grid.
It was originally devised by Edward de Bono and appeared in the book, "The Five Day Course in Thinking".
Details will be shown during execution.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.lgame
**Cmd.lgame >> main: args
	Basic new breakFor implicitDeclareArray run: #Cmd.lgame.source

small scale war
$Id: mulk/basic combat.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	combat
.caption DESCRIPTION
You are fighting a small scale war with the computer.
You have 72,000 troops which you first must distribute among your Army, Navy, and Air Force.
You may distribute them in any way you choose asl long as you don't use more than 72,000.

You then attack your opponent (the computer) and input which service and the number of men you wish to use.
The computer then tells you the outcome of the battle, gives you the current statstics and allows you to determine your next move.

After the second battle, it is decided from the total statstics whether you win or lose or if a treaty is signed.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Bob Dores, Milton, Massachusetts.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.combat
**Cmd.combat >> main: args
	Basic new run: #Cmd.combat.source

trick taking card game for 4 player
$Id: mulk/basic octrix.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	octrix
.caption DESCRIPTION
This is a card game for up to four plaers, or three players plus the computer.
A deck of 32 cards is used with ace through eight in each of the four suit.
All 32 of the card sare dealt out at the beginning of the game, eight to each player.
On each hand, each player discards one card depending on the rules of the game either the high card discard or the low card discard wins that trick.
After eight tricks a new hand is dealt and pay proceeds as before.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.octrix
**Cmd.octrix >> main: args
	Basic new implicitDeclareArray breakFor run: #Cmd.octrix.source

open four doors
$Id: mulk/basic doors.m 1442 2025-06-12 Thu 10:05:28 kt $
...
You have a key ring containing keys numbered from zero and you have some tries to open all four doors.
As an added hooker, some keys may open more than one door.
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.doors
**Cmd.doors >> main: args
	Basic new implicitDeclareArray run: #Cmd.doors.source

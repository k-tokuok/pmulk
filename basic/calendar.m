...
$Id: mulk/basic calendar.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	calendar
.caption DESCRIPTION
This program prints out a calendar for any year.
You must specify the starting day of the week of the year in Statement 130 (Sunday (0), Monday (-1), Tuesday (-2), etc).
You must also make two changes for leap year in Statements 360 and 620.
Running the program produces a nice 12-month calendar.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Geoffrey Chase, Abbey, Portsmouth, Rhode Island.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.calendar
**Cmd.calendar >> main: args
	Basic new breakFor run: #Cmd.calendar.source

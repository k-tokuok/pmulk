single player golf game
$Id: mulk/basic golf.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	golf
.caption DESCRIPTION
This is a single player golf game.
The program asks your handicap (maximum of 30) and your area of difficulty.
You have a full bag of 29 clubs plus a putter.
On the course you have to contend with rough, trees, on and off fairway, sand traps, and water hazards.
In addition, you can hook, slice, go out of bounds, or hit too far.
On putting, you determine the potency factor (or percent of swing).
Until you get the swing of the game (no pun intended), you'll probably want to use a fairly high handicap.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.golf
**Cmd.golf >> main: args
	Basic new run: #Cmd.golf.source

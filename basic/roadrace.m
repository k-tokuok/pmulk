roadrace on the route 20
$Id: mulk/basic roadrace.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	roadrace
.caption DESCRIPTION
You are the driver of a race car on the notorious NY Route 20.
You'll have to drive 5 miles with 1/2 gallon of gas, while keepint alert for changes in the road conditions, other cars, etc.

At the start you pick your car and course.
During the race you control braking and acceleration.

Watch out or passing another car!
If you try to go the same speed he's going, you're going to meet a Grayhound bud head-on!

The game is tough to win.
I usually wipe out in a curve or run out of gas.
...
Originaly appeared in Creative Computing, Jan/Feb 1975.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.roadrace
**Cmd.roadrace >> main: args
	Basic new run: #Cmd.roadrace.source

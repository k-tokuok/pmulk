...
$Id: mulk/basic splat.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	splat
.caption DESCRIPTION
Splat simulates a parachute jump in which you try to open your parachute at the last possible moment without going splat!
You may select your own terminal velocity or let the computer do it for you.
You may also select the acceleration due to gravity or, again, let the computer do it in which case you might wind up on any one of eight planets (out to Neptune), the moon, or the sun.

The computer then tells you the height you're jumping from and asks for the seconds of free fall.
It then divides your free fall time into eight intervals and gives you progres reports on your way down.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
John Yegge, Oak Ridge Associated Unversities.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.splat
**Cmd.splat >> main: args
	Basic new run: #Cmd.splat.source

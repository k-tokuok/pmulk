one lap around a grand prix circuit
$Id: mulk/basic grnprx.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	grnprx
.caption DESCRIPTION
You are attempting to complete one lap around a grand prix circuit against one of six opponents, everything from a US Postal delivery truck to a 1974 Ferrari.
The track consists of four straightaways and four curves with different maximum speeds possible for each one.
Depending on which car you select for your own, you can take these curves and straights at different speeds.
Also, the car you select will have different braking characteristics which may allow you to head into a curve at a higher speed and then apply the brakes at the last minute.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.grnprx
**Cmd.grnprx >> main: args
	Basic new run: #Cmd.grnprx.source

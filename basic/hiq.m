peg solitaire
$Id: mulk/basic hiq.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	hiq
.caption DESCRIPTION
This is computerized version of an old European solitaire game of logic.
The game starts with a pegboard shaped like a cross having pegs in every hole but the center.
The object is to remove all 32 pegs, or as many as possible, by jumping into an empty hole, then removing the jumped peg.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.hiq
**Cmd.hiq >> main: args
	Basic new run: #Cmd.hiq.source

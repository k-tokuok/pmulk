rock, scissors, paper
$Id: mulk/basic rocksp.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	rocksp
.caption DESCRIPTION
Computerized version of rock-scissors-paper.
You can play up to ten games vs. the computer.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Charles Lund, Hague, Netherlands.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.rocksp
**Cmd.rocksp >> main: args
	Basic new run: #Cmd.rocksp.source

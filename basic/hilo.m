guess the number to win dollars
$Id: mulk/basic hilo.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	hilo
.caption DESCRIPTION
An adaptation of the game GUESS; however, instead of just guessing a number between 1 and 100, in this game you win dollars when you guess the numner.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Dean Altman, Fort Worth, Texas.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.hilo
**Cmd.hilo >> main: args
	Basic new run: #Cmd.hilo.source

escape from interceptor robots
$Id: mulk/basic chase.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	chase
.caption DESCRIPTION
Chase puts you in a maze made up of high-voltage fences and posts.
This in itself isn't too unpleasant but there're also the five interceptor robots bent on just one thing -- your destruction.
If these robots touch you ... that's the end of the game (and you).
There's one hope -- make the robots hit the maze, or each other (thry're like people -- sometimes they'd rather be alone).
If you destroy them all, you win!
If you find yourself in a totally hopeless situation, you have the option of making a tremendous leap to a random location (which may well be on top of a fence or a guard).
.caption ORIGIN
...
Modified by Bill Cotter, Arnold Loveridge.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.chase
**Cmd.chase >> main: args
	Basic new implicitDeclareArray run: #Cmd.chase.source

master bagels
$Id: mulk/basic mstrbgls.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	mstrbgls
.caption DESCRIPTION
This is a fascinating, general purpose, deductive logic game.
It rolls Bagels, Mastermind, bulls and cows, etcetra, into one general deductive logic game.
If you want to Bagels, set the inputs to N, 3, 9 (N is the number of games you wish to play).
If you want to play master mind, set the inputs to N, 4, 6.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.mstrbgls
**Cmd.mstrbgls >> main: args
	Basic new breakFor run: #Cmd.mstrbgls.source

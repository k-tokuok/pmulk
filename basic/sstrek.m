super star trek
$Id: mulk/basic sstrek.m 1442 2025-06-12 Thu 10:05:28 kt $
...
A detailed description will be given during the run.
.caption ORIGIN
...
Modified by Dave Ahl, Bob Leedon and many.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.sstrek
**Cmd.sstrek >> main: args
	Basic new run: #Cmd.sstrek.source0;
	Basic new run: #Cmd.sstrek.source

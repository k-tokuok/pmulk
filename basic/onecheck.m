diagonal jump puzzle
$Id: mulk/basic onecheck.m 1442 2025-06-12 Thu 10:05:28 kt $
...
It is wasy to remove 30 to 39 checkers, a challenge to remove 40 to 44, and a substantial feat to remove 45 to 47.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.onecheck
**Cmd.onecheck >> main: args
	Basic new run: #Cmd.onecheck.source

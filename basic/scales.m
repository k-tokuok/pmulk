musical scales
$Id: mulk/basic scales.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	scales
.caption DESCRIPTION
This program tests your knowledge of different types of musical scales.
It generates 11 types of scales: major, natural minor, harmonic minor, Hungarian minor, doria, phygian, lydian, mixolydian, locrian, and whole tone.

Prior to running the program, test yourself off line on a sheet of paper by writing down several types of scales and 8 notes starting at a note chosed by you.
Then run the program to check your answers.
.caption ORIGIN
More basic computer games.
.
source from https://www.roug.org/
.caption AUTHOR
Marvin S. Thostenson, School of Music, University of Iowa.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.scales
**Cmd.scales >> main: args
	Basic new breakFor capsoff run: #Cmd.scales.source

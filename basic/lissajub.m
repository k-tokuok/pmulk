prints lissajous patterns
$Id: mulk/basic lissajub.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	lissajub
.caption DESCRIPTION
This program prints Lissajous patterns.
You enter relative X and Y frequencies and Y phase of pi.
The relative frequencies for X and Y must be a positive number on or greater.
The phase may be between zero and any number you want.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.lissajub
**Cmd.lissajub >> main: args
	Basic new run: #Cmd.lissajub.source

...
$Id: mulk/basic lem.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	lem
.caption DESCRIPTION
Most comprehensive lunar landing simulation and permits you to control the time interval of fireing, the thrust, and the attitude angle.
It also allows you to work in the metric of English system of measurement.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
William Labaree II, Alexandria, Virginia.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.lem
**Cmd.lem >> main: args
	Basic new run: #Cmd.lem.source

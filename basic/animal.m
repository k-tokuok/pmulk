guess the animal
$Id: mulk/basic animal.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	animal
.caption DESCRIPTION
Unlike other computer games in which the computer picks a number of letter and you must guess what is it, in this game you think of an animal and the computer asks you questions and tries to guess the name of your animal.
If the computer guesses incorrectly, it will ask you for a question that differentiates the animal it guesses drom the one you were thinking of.
In this way the computer "learns" new animals.
Questions to differentiates new animals should be input without a question mark.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Arthur Luehrmann at Dartmouth College.

Modified by Nathan Teichholtz at DEC and Steve North at Creative Computing.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.animal
**Cmd.animal >> main: args
	Basic new run: #Cmd.animal.source

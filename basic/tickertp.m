ticker tape
$Id: mulk/basic tickertp.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	tickertp
.caption DESCRIPTION
This program inputs a line of characters from a Teletype, and then punches the shapes of each letter on paper tape.
.caption ORIGIN
More basic computer games.
.
source from https://www.roug.org/
.caption AUTHOR
Bill Gardner and Jim Laurus.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.tickertp
**Cmd.tickertp >> main: args
	Basic new run: #Cmd.tickertp.source

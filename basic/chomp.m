game board of chomp
$Id: mulk/basic chomp.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	chomp
.caption DESCRIPTION
Chomp is an adaptation of a mathematical game originally described by Martin Gardner in the January 1973 issue of Scientific American.

The computer is only the moderator; it is not a player.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Peter Sessions, People's Computer Campany.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.chomp
**Cmd.chomp >> main: args
	Basic new breakFor run: #Cmd.chomp.source

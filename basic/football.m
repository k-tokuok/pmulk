football simulation
$Id: mulk/basic football.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	football
.caption DESCRIPTION
A football simulation that plays against a computer.
You have a choice of seven offensive plays.
On defense the computer seems to play a zone defense, but you have no choice of plays.
The computer program presents the necessary rules as you play, and it is also the referee and determines penalties when a n infraction is committed.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Jon Kemeny, Dartmouth.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.football
**Cmd.football >> main: args
	Basic new implicitDeclareArray run: #Cmd.football.source

do not take the last match
$Id: mulk/basic 23match.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	23match
.caption DESCRIPTION
You start with 23 matches lying on a table.
On each turn, you may take 1, 2 or 3 matches.
You alternate moves with the computer and the one who has to take the last match loses.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.23match
**Cmd.23match >> main: args
	Basic new run: #Cmd.23match.source

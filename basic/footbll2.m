pvp football simulation
$Id: mulk/basic footbll2.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	footbll2
.caption DESCRIPTION
The computer referees a game played between two human players.
Each player gets a list of twenty plays with a code value for one.
This list should be kept confidential from your opponent.
All twenty plays are offensive, a defensive play is specified by defending against a type of offensive play.
A defense is good for other similar type of plays, for example, a defense againse a flare pass is very good against a half-back option.
.
If you don't read the instructions, the game starts.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Raymond Miseyka, Butler, Pennsylvania.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.footbll2
**Cmd.footbll2 >> main: args
	Basic new run: #Cmd.footbll2.source

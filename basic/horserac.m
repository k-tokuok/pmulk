one-mile horse race
$Id: mulk/basic horserac.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	horserac
.caption DESCRIPTION
This program simulates a one-mile horse face for three-year old thoroughbeds.
Up to ten people may place bets on the race up to $10,000 each.
However, you may only bet to win.
You place your bet by inputting the number of the horse, a comma, and the amount of your bet.
The computer then shows the position of the horses at seven points around the track and at the finish.
Payoffs and winnings are shown at the end.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Laurie Chevalier, South Portland.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.horserac
**Cmd.horserac >> main: args
	Basic new implicitDeclareArray run: #Cmd.horserac.source

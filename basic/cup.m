throw the ball into the cup
$Id: mulk/basic cup.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	cup
.caption DESCRIPTION
Cup is a cute little game in which a cup is located thirty lines down on your video display screen and a random number of spaces from one to sixty to the right of the left margin.
The pull of gravity varies from one to ten lines per second per second.
You are then asked in this program what push you would like to give the ball from left to right across the screen in spaces per second.
The program then traces the path of the ball from the left margin of the screen as it falls down and hopefully into the cup.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.cup
**Cmd.cup >> main: args
	Basic new breakFor run: #Cmd.cup.source

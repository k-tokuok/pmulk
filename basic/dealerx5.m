dealer's choice
$Id: mulk/basic dealerx5.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	dealerx5
.caption DESCRIPTION
In this game, you, the player, are given $100 to start with.
You then play five card games loosely modeled on casino gambling games, but with peculiar variations.
The five games are well-explained in the rules.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.dealerx5
**Cmd.dealerx5 >> main: args
	Basic new run: #Cmd.dealerx5.source

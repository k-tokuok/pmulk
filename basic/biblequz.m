quiz about the Bible
$Id: mulk/basic biblequz.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	biblequz
.caption DESCRIPTION
BIBLE QUIZ is a program which administers up to 25 questions about the Bible to the user.
If the answer given to a question is correct, the program proceeds to the next quetion.
If an incorrect answer is given, the program gives the correct answer.
In either case, the biblical reference is given.
.caption ORIGIN
More basic computer games.
.
source from https://www.roug.org/
.caption AUTHOR
Steve Wentworth, Muskingum College.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.biblequz
**Cmd.biblequz >> main: args
	Basic new run: #Cmd.biblequz.source

game of checkers
$Id: mulk/basic checkers.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	checkers
.caption DESCRIPTION
Computer checker with double or triple jump and tell which player has won the game.
But computer does not play a particularly good game.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.checkers
**Cmd.checkers >> main: args
	Basic new run: #Cmd.checkers.source

...
$Id: mulk/basic lunar.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	lunar
.caption DESCRIPTION
You set the burn rate of the retro rockets (pounds of fuel per second) every 10 seconds and attempt to achieve a soft landing on the moon.
200 lbs/sec really puts the brakes on, and 0 lbs/sec is free fall.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Jim Storer, Lexington High School.

Converted to BASIC by David Ahl, Creative Computing.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.lunar
**Cmd.lunar >> main: args
	Basic new run: #Cmd.lunar.source

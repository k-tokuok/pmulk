simulation game of govering ancient sumeria
$Id: mulk/basic hamurabi.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	hamurabi
.caption DESCRIPTION
You direct the administrator of Sumeria, Hamurabi, how to manage the city.
The city initially has 1,000 acres, 100 people and 3,000 bushels of grain in storage.

You may buy and sell land with your neighboring city -- states for bushels of grain -- the price will vary between 17 and 26 bushels per acre.
You also must use grain to feed your people and as seed to plant the next year's crop.
...
You will also find that managing just the few resources in this game is not a trivial job over a period of say ten years.
The crisis of population density rears its head very rapidly.
.caption ORIGIN
...
Converted to BASIC by David Ahl, Creative Computing.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.hamurabi
**Cmd.hamurabi >> main: args
	Basic new run: #Cmd.hamurabi.source

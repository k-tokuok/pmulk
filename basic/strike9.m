number taking game
$Id: mulk/basic strike9.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	strike9
.caption DESCRIPTION
This is a simple game based on the number 1 through 9, and a pair of dice.
First, the computer rolls a random number for your "dice".
Then you must take that number from the total of your board numbers 1-9.
To win you must remove all of your board number.
With each roll you must remove the total number of that roll from the board or you lose.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.strike9
**Cmd.strike9 >> main: args
	Basic new breakFor run: #Cmd.strike9.source

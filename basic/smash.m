one-lap jalopy race
$Id: mulk/basic smash.m 1442 2025-06-12 Thu 10:05:28 kt $
...
There is one big problem: you don't know the shape of the course or the safe speed with which you can go around the corners.
Consequently you're likely smash up fairly frequentry or else go so slowly that you don't earn a good placing among the winners.
However, after four or five plays of the game you'll begin to get the hang of it and you'll be able to whip around the course in grand fashion.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.smash
**Cmd.smash >> main: args
	Basic new run: #Cmd.smash.source

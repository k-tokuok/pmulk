debate with your father
$Id: mulk/basic father.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	father
.caption DESCRIPTION
This program loosely simulates a debate with your father about goint out on Saturday night.
After you win or lose the debate, then Saturday night approaches and you must decide whether or not to actually go out.
When all is said and gone, the computer will give you a score on a scale of minus seven to plus four.
.caption ORIGIN
...
Modified by Victor Nahigian.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.father
**Cmd.father >> main: args
	Basic new run: #Cmd.father.source

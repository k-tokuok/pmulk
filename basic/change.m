...
$Id: mulk/basic change.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	change
.caption DESCRIPTION
Pretends it is the cachier at your friendly neighborhood candy store.
You tell it the cost of the item(s) you are buying, the amount of your payment, and it will automatically (!) determine your correct change
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Dennis Lunder, People's Computer Company.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.change
**Cmd.change >> main: args
	Basic new run: #Cmd.change.source

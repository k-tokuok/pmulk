facts about date of birth
$Id: mulk/basic weekday.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	weekday
.caption DESCRIPTION
This program gives facts about your date of birth.

You merely either today's date and your date of birth.
The computer then tells you the day of the week of your birth date, your age, and how much time you have spent sleeping, eating, working, and relaxing.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.weekday
**Cmd.weekday >> main: args
	Basic new run: #Cmd.weekday.source

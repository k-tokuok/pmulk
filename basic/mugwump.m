find the four mugwumps
$Id: mulk/basic mugwump.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	mugwump
.caption DESCRIPTION
Your objective in this game is to find the four Mugwumps hiding on various squares.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Bud Valenti of Project SOLO, Pittsburgh, Pennsylvania.

Modified by Bob Albrecht, People's Computer Company.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.mugwump
**Cmd.mugwump >> main: args
	Basic new run: #Cmd.mugwump.source

bombardment
$Id: mulk/basic bmbrdmnt.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	bmbrdmnt
.caption DESCRIPTION
Bombardment is played on two, 5x5 grids or boards with 25 outpost locations numbered 1 to 25.
Both you and the computer have fout platoons of troops that can be located at any four outposts on your respective grids.

At the start of the game, you locate (or hide) your four platoons on your grid.
The computer does the same on its grid.
You then take turns firing missiles or bombs at each other's outposts trying to destroy all four platoons.
The one who finds all four opponents' platoons first, wins.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Martin Burdash, Parlin, New Jersey

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.bmbrdmnt
**Cmd.bmbrdmnt >> main: args
	Basic new run: #Cmd.bmbrdmnt.source

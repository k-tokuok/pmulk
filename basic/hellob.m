...
$Id: mulk/basic hellob.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	hellob
.caption DESCRIPTION
This is a sample of one of a great number of conversational programs.
In a sense, it is like a CAI program except that its responses are just good fun.
Whenever a computer is exhibited at a convention of conference with people that have not used a computer before, the conversational programs seem to get the first activity.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.hellob
**Cmd.hellob >> main: args
	Basic new run: #Cmd.hellob.source

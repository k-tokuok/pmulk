...
$Id: mulk/basic cncntrtn.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	cncntrtn
.caption DESCRIPTION
This children's card game for any number of players is also called memory, or pelmanism.
It is easy to play and is an excellent test of memory and observation.
The computer version here simulates the actual game except that if only alows one player to play.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.cncntrtn
**Cmd.cncntrtn >> main: args
	Basic new run: #Cmd.cncntrtn.source

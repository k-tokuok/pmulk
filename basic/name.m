conversation about your name
$Id: mulk/basic name.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	name
.caption DESCRIPTION
NAME is a silly little ice-breaker to get a relationship going between a computer and a shy human.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.name
**Cmd.name >> main: args
	Basic new run: #Cmd.name.source

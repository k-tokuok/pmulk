...
$Id: mulk/basic camel.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	camel
.caption DESCRIPTION
Your object is to travel 200 miles across the great Gobi Desert.
You're being chased by a tribe of knock-kneed pygmies.
You have one quot of water which will last you for six drinks; it may be renewed if you find an oasis or, if you are found by another traveller, you may get an additional half-quart of water.
During your journey you encounter all types of hazards such as sand storms, wild Berbers and possible injuries to your camel.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.camel
**Cmd.camel >> main: args
	Basic new run: #Cmd.camel.source

nevada style craps
$Id: mulk/basic craps.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	craps
.caption DESCRIPTION
The game of craps played according to standard Nevada craps table rules.
.item
...
If you roll 7, you lose and the dice hange hands when this happens.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.craps
**Cmd.craps >> main: args
	Basic new run: #Cmd.craps.source

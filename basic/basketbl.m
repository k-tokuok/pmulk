...
$Id: mulk/basic basketbl.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	basketbl
.caption DESCRIPTION
This program simulates a game of basketball between Dartmouth College and an opponent of your choice.
You are the Dartmouth captain and control the type of shot and defense during the course of the game.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Charles Bacheller, Dartmouth College.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.basketbl
**Cmd.basketbl >> main: args
	Basic new implicitDeclareArray run: #Cmd.basketbl.source

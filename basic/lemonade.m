lemonade stand
$Id: mulk/basic lemonade.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	lemonade
.caption DESCRIPTION
Player moves several rounds of running a lemonade stand.

A detailed description will be given at run time.
.caption ORIGIN
source from https://altairclone.com/forum/viewtopic.php?f=2&t=171
.caption AUTHOR
Bob Jamison, Minnesota Educational Computing Consortium (MECC), 1973.

Modified for the apple II by Charlie kellner, 1979.

Modifyed for the altair 8800 by GMH, 2016.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.lemonade
**Cmd.lemonade >> main: args
	Basic new longVar run: #Cmd.lemonade.source
	
*->Cmd.lemonade.source
4 CL$="---": REM CLEAR SCREEN
5 GOSUB 11000
...
100 REM * * *
110 REM MODIFIED FOR THE ALTAIR 8800
120 REM JULY, 2016
130 REM BY GMH
...
550 IF D > 6 THEN C = 5
560 PRINT "$0.0";RIGHT$(STR$(C),1): PRINT
570 C1 = C * .01
580 R1 = 1
...
940 GOTO 890
950 PRINT
951 PRINT "HOW MANY ADVERTISING SIGNS (";RIGHT$(STR$(S3*100),2);" CENTS"
...
2310 X3 = 1:R3 = 0
2320 SC = 5: GOSUB 15000: PRINT CL$
...
11100 PRINT CL$
11270 PRINT "      LEMONADE STAND"
11280 REM PRINT "COPYRIGHT 1979 APPLE COMPUTER INC."
11290 FOR TI=1 TO 500:NEXT TI
11490 RETURN
...
12210 A$ = LEFT$ (A$,1): IF A$ <> "Y" AND A$ <> "N" THEN GOTO 12200
...
15400 PRINT
18000 INPUT "PRESS ENTER TO CONTINUE, Q TO QUIT...";IN$
18010 IF IN$="Q" THEN 31111
18020 RETURN
31111 PRINT CL$ : INPUT "WOULD YOU LIKE TO PLAY AGAIN? ";IN$
31112 IF IN$="Y" THEN 150 ELSE PRINT CL$:END

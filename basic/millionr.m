...
$Id: mulk/basic millionr.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	millionr
.caption DESCRIPTION
In this game, the computer takes you through your life from birth to death.
Along the way, you're asked to make some petty and some other rather crucial decisions.
Some of these decisions regard what kind of job you want, how much you bet in Las Vegas, whether you buy a valuable coin, whether you elect to take a vacation or a second job, stock purchases -- buying and selling, automobile accidents, tornade, and the like.

At the end of your life (it goes by in a flash!) the computer tallies up you gains and your losses and tells you where you stand relative to becoming a millionaire.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.millionr
**Cmd.millionr >> main: args
	Basic new run: #Cmd.millionr.source

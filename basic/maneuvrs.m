maneuver the shuttle
$Id: mulk/basic maneuvrs.m 1442 2025-06-12 Thu 10:05:28 kt $
...
You must deliver a message to each of four starbases, in the least total time.

See the running description for details.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.maneuvrs
**Cmd.maneuvrs >> main: args
	Basic new run: #Cmd.maneuvrs.source

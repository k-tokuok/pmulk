resource management as premier
$Id: mulk/basic king.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	king
.caption DESCRIPTION
This is one of the more comprehensive, difficult, and interesting land and resource management.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
James A. Storer, Lexington.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.king
**Cmd.king >> main: args
	Basic new run: #Cmd.king.source

puzzle that flips everything
$Id: mulk/basic flipflop.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	flipflop
.caption DESCRIPTION
Change a row of ten X's to a row of ten O's by typing a number corresponding to the position of an X in the line.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Michael Cass, New Hyde Park, New York.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.flipflop
**Cmd.flipflop >> main: args
	Basic new run: #Cmd.flipflop.source

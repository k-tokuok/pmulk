open the safe box
$Id: mulk/basic safe.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	safe
.caption DESCRIPTION
You are trying to open a safe by turning or twisting a dial back.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.safe
**Cmd.safe >> main: args
	Basic new run: #Cmd.safe.source

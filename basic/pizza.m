pizza delivery
$Id: mulk/basic pizza.m 1442 2025-06-12 Thu 10:05:28 kt $
...
Armed with a map of the city, you must then tell your delivery boy the address where the pizza to be delivered.
If the pizza is delivered to the correct address, the customer phones you and thanks you; if not, you must give the driver the correct address until the pizza gets delivered.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Unknown at University of Georgia, Athens, Georgia.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.pizza
**Cmd.pizza >> main: args
	Basic new implicitDeclareArray run: #Cmd.pizza.source

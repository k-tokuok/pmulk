guess three things about the roll of a pair of dice
$Id: mulk/basic bobstons.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	bobstons
.caption DESCRIPTION
The idea for this number game was derived from a contest called "Bobstones" described in the novel Watership Down.
The object of Bobstones is to guess three things about the roll of a pair of dice.
...
The winner if the first player to score 11 points.
If a tie results, the winner is the first player to break the tie.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.bobstons
**Cmd.bobstons >> main: args
	Basic new run: #Cmd.bobstons.source

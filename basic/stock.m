...
$Id: mulk/basic stock.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	stock
.caption DESCRIPTION
This program plays the stock market.
You will be given $10,000 and may buy or sell stocks.
Stock prices and trends are generated rancomly; therefore, this models does not represent exactly what happens on the exchange.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
D. Passel, L. Braun, and C. Losik, Huntington Computer Project, SUNY, Stony Brook, N. Y.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.stock
**Cmd.stock >> main: args
	Basic new run: #Cmd.stock.source

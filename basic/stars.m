guess the number from the proximity hint
$Id: mulk/basic stars.m 1442 2025-06-12 Thu 10:05:28 kt $
...
You try to guess the number and the computer gives you clues to tell you how close you're getting.
One star (*) means you're far away from the number; seven stars (*******) means you're really close.
You get 7 guesses.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.stars
**Cmd.stars >> main: args
	Basic new run: #Cmd.stars.source

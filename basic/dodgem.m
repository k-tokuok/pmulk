pieces race at right angles across a square board
$Id: mulk/basic dodgem.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	dodgem
.caption DESCRIPTION
Dodgem is a game originally devised in 192 by Colin Vout, then a student at the University of Cambridge, England.
It got its major pblicity from Martin Gardner who discussed it in the June 1975 issue of Scientific American, Complete instructions are in run.

It may be played by two players in which case the computer is the referee, or by one player against the computer.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.dodgem
**Cmd.dodgem >> main: args
	Basic new breakFor implicitDeclareArray run: #Cmd.dodgem.source

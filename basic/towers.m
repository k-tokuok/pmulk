towers of hanoi
$Id: mulk/basic towers.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	towers
.caption DESCRIPTION
You must transfer the disks from the needle 1 to 3.
One at a time, never putting a larger disk on a smaller disk.
The disks are referred to by size -- i.e., the smallest is 3, next 5, 7, 9, 11, 13, and 15.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.towers
**Cmd.towers >> main: args
	Basic new run: #Cmd.towers.source

pictorial drill
$Id: mulk/basic mathdice.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	mathdice
.caption DESCRIPTION
The program presents pictorial drill on addition facts using printed dice with no reading involved.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Jim Gerrish, Bernice A. Ray School, Hanover, New Hampshire.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.mathdice
**Cmd.mathdice >> main: args
	Basic new run: #Cmd.mathdice.source

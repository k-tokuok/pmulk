run down a course
$Id: mulk/basic slalom.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	slalom
.caption DESCRIPTION
This game simulates a slalom run down a course with one to 25 gates.
The user picks the number of gates and has some control over his speed down the course.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
J. Panek, Dartmouth College.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.slalom
**Cmd.slalom >> main: args
	Basic new implicitDeclareArray run: #Cmd.slalom.source

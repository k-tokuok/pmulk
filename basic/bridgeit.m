bridge from the left to right
$Id: mulk/basic bridgeit.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	bridgeit
.caption DESCRIPTION
The object of this game is for you to go from the left column to the right column by connecting the O's.
The computer must from the top to the bottom by connecting the X's.
.caption ORIGIN
More basic computer games.
.
source from https://www.roug.org/
.caption AUTHOR
Michael Kass, Miles Barel, and Alan Segal.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.bridgeit
**Cmd.bridgeit >> main: args
	Basic new run: #Cmd.bridgeit.source

...
$Id: mulk/basic bagels.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	bagels
.caption DESCRIPTION
The computer picks a 3-digit secret number using the digits 0 to 9 and you attempt to guess what it is.
You are allowed up to twenty guesses.
No digit is repeated.
After each guess the computer will give you clues about your guess as follows:
...
.caption AUTHOR
D. Resek and P. Rowe, the Lawrence Hall of Science, Berkeley, California.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.bagels
**Cmd.bagels >> main: args
	Basic new breakFor run: #Cmd.bagels.source

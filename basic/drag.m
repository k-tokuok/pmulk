drag race
$Id: mulk/basic drag.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	drag
.caption DESCRIPTION
Drag allows the user to design his own dragster and then race it against a dragster designed by another player or the computer.
You must specify the horsepower, rear end ratio, tire width, and tire diameter.
There are no limits to these parameters.
.caption ORIGIN
...
This program came from the Hewlett-Packard User Library.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.drag
**Cmd.drag >> main: ars
	Basic new implicitDeclareArray run: #Cmd.drag.source

invaluable aid for preparing speeches
$Id: mulk/basic buzzword.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	buzzword
.caption DESCRIPTION
Invaluable aid for preparing speeches and briefings about educational technology.
This buzzword generator privides sets of three highly acceptable words to work into your material.
Your audience will never know that the phrases don't really mean much of anything because they sound so great!
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.buzzword
**Cmd.buzzword >> main: args
	Basic new run: #Cmd.buzzword.source

warfish in world war ii
$Id: mulk/basic warfish.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	warfish
.caption DESCRIPTION
In this game, you're the commander of an American submarine with a mission to seek out and destroy as many Japanese ships as possible during Warld War II.

You may up your periscope to search for Japanese ships, you may launch your torpedos, or you may dive to avoid Japanese ships that are attacking you.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.warfish
**Cmd.warfish >> main: args
	Basic new run: #Cmd.warfish.source

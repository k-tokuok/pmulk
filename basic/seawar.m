game of sea war
$Id: mulk/basic seawar.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	seawar
.caption DESCRIPTION
You are the commander of a fleet of ships operating in enemy territory.
Your task force consists of 9 ships, and the enemy has 9 ships.
Whoever sinks all of the opponent's ships first wins the campaign.
.caption ORIGIN
...
Revises by David S. Paxton and Mary T. Dobbs, Mathematics and Science Center, Glen Allen, Virginia.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.seawar
**Cmd.seawar >> main: args
	Basic new run: #Cmd.seawar.source

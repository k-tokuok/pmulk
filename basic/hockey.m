simulation of a ice hockey game
$Id: mulk/basic hockey.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	hockey
.caption DESCRIPTION
This is a simulation of a ice hockey game.
The computer, in this case, moderates and referees the play between two human opponents.
Of course, one person could play both sides.

The program asks for team names, player names, and even the name of the referee.
Four types of shot are permitted and a shot may be aimed at one of four areas.
You are also asked about passing.
The game is very comprehensive with logs of action, face offs, blocks, passes, 4 on 2 situations, and so on.
Unfortunately there are no penalties.
.caption ORIGIN
...
Modifications by Steve North, Creative Computing.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.hockey
**Cmd.hockey >> main: args
	Basic new run: #Cmd.hockey.source
...
630 rem G=H(J-4):G1=J(J-1):G2=H(J-2):Z1=1:GOTO 770 -- may error
631 G=H(J-4):G1=H(J-1):G2=H(J-2):Z1=1:GOTO 770

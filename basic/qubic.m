tic tac toe in a 4x4x4 cube
$Id: mulk/basic qubic.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	qubic
.caption DESCRIPTION
You must get 4 markers in a row or diagonal along any 3-dimentional plane in order to win.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.vintage-basic.net/
.caption AUTHOR
Unknown in Dartmouth College.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.qubic
**Cmd.qubic >> main: args
	Basic new run: #Cmd.qubic.source
	
*->Cmd.qubic.source
50 REM PRINT CHR$(26):WIDTH 80

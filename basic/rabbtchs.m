rabbit chase
$Id: mulk/basic rabbtchs.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	rabbtchs
.caption DESCRIPTION
Seemingly, the purpose of this game is to chase-down and catch a rabit.
Now this rabbit is an elusive little devil -- it can hop randomly in any direction.
You can run at least as fast as the rabbit, maybe even faster (the computer will decide).
You must get within 20 units of the rabbit to be able to catch him.
Before each hop, the computer will print out your position, the rabbit's position, the direction the rabbit is going to jump, and your closest approach on the last hop.
You are to tell the computer which direction you wish to run.
All coordinates and directions are as a geometer would mark them on a standard Cartesian Coordinate System.
.caption ORIGIN
More basic computer games.
.
source from https://www.roug.org/
.caption AUTHOR
Ted C. Park of Pacific Union College.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.rabbtchs
**Cmd.rabbtchs >> main: args
	Basic new run: #Cmd.rabbtchs.source

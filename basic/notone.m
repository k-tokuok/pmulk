...
$Id: mulk/basic notone.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	notone
.caption DESCRIPTION
The game, Not One, sometimes known as Pig, is played with two players and a pair of dice.
There are ten rounds in the game; one round consisting of one turn for each player.
Players add the score that they attain on each round and the player with the highest score after ten rounds is the winner.

On each turn, the player may roll the two dice from one to as many times as he wishes.
If the total of the dice on any roll after the first equals the total shown on the first roll, his score is then zero for the entire turn and the dice pass to the other player.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.notone
**Cmd.notone >> main: args
	Basic new breakFor run: #Cmd.notone.source

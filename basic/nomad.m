navigate to gramma nomad house
$Id: mulk/basic nomad.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	nomad
.caption DESCRIPTION
"Gramma Nomad" is a person who doesn't really know where she wants to live, so she moves to a new house every game.
Then she sends you a telegram asking you to visit her.
The object of the game is to successfully navigate your way through the streets of Garbonzo City to Gramma's house.
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.nomad
**Cmd.nomad >> main: args
	Basic new run: #Cmd.nomad.source

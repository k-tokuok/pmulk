move queen to lower left
$Id: mulk/basic queen.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	queen
.caption DESCRIPTION
In this game, the queen can only move to the left, down, and diagonally down to the left.

The object of the game is to place the queen in the lower left-hand square (no. 158), by alternating moves between you and the computer.
The one to place the queen there wins.

You go first and place the queen in any one of the squares on the top row or the right-hand column.
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.queen
**Cmd.queen >> main: args
	Basic new run: #Cmd.queen.source

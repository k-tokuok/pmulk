conversation about your problem
$Id: mulk/basic eliza.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	eliza
.caption DESCRIPTION
Eliza is a program that accepts natural English as input and carries on a reasonably coherent conversation based on the psychoanalytic techniques of Carl Rogers.
You will have to forgive Eliza for being poor English student.
You'll find that it is best not to use punctuation in your input, and you'll have to carry the conversation.

If you want to quit, input 'shut up'.
.caption ORIGIN
More basic computer games.
.
source from https://www.roug.org/
.caption AUTHOR
Originally progammed in Lisp by Joseph Weizenbaum, MIT.

Converted to Basic by Jeff Shrager and modified by Steve North.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.eliza
**Cmd.eliza >> main: args
	Basic new run: #Cmd.eliza.source

create inkblots similar to Rorschach test
$Id: mulk/basic inkblot.m 1442 2025-06-12 Thu 10:05:28 kt $

*[man]
.caption SYNOPSIS
	inkblot
.caption DESCRIPTION
INKBLOT is a program that creates "inkblots" similar to those used in the famous Rorschach Inkblot Test.
The program generates these inkblots randomly so taht literally millions of different patterns can be produced.
Many of these patterns are quite intersting and serve not only as conversation pieces, but also as good example of computer "art".
.caption ORIGIN
...
*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.inkblot
**Cmd.inkblot >> main: args
	Basic new run: #Cmd.inkblot.source

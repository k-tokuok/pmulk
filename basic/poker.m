draw poker vs computer
$Id: mulk/basic poker.m 1442 2025-06-12 Thu 10:05:28 kt $
...
At the start of the game, each player is given $200.
The game ends when either player runs out of money, although if you go broke the computer will offer to buy your wristwatch or diamond tie tack.
.caption ORIGIN
Basic computer games micro computer edition.
.
source from http://www.classicbasicgames.org/
.caption AUTHOR
Christopher Hall, Trinity Colledge, Hartford, Connecticut.

*entry.@
	Mulk import: "basic";
	Object addSubclass: #Cmd.poker
**Cmd.poker >> main: args
	Basic new breakFor run: #Cmd.poker.source

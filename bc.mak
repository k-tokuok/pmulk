...
#	$Id: mulk bc.mak 1092 2023-07-16 Sun 09:04:11 kt $
#
#	make -fbc.mak [bcver=5|7] [setup=setup.m]
#		bcver=5 for Borland C++ 5.5.1.
#		bcver=7 for Embacadero C++ 7.3 of C++ Builder 10.2.
#
#	compiler defines __BORLANDC__ implicit.
#
.SUFFIXES: .obj .c
...
cc=bcc32
uflags=-WM
cflags=$(uflags) -c -gb -O2 -DNDEBUG -DINTR_CHECK_P=1
lflags=$(uflags)
!else
cc=bcc32c
uflags=
cflags=$(uflags) -O2 -DNDEBUG -DINTR_CHECK_P=1
lflags=$(uflags)
!endif
